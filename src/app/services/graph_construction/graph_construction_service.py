...
def construct_graph(
    ...
    norm_graph_ray_cast_distance = normalize_pixel_config_value(
        config.graph_ray_cast_to_symbol_pixels, image_width, image_height)
    ...
    norm_graph_line_buffer = normalize_pixel_config_value(config.graph_line_buffer_pixels,
                                                          image_width,
                                                          image_height)
    norm_graph_symbol_contact = normalize_pixel_config_value(config.graph_symbol_contact_pixels,
                                                             image_width,
                                                             image_height)
    ...
    line_connection_candidates = create_line_connection_candidates(
        ...
        norm_graph_ray_cast_distance,
        norm_graph_symbol_contact,)
    end_time = time.time()
